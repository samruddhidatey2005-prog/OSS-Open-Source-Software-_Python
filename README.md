Student Details
Name: ["Samruddhi"]
Registration Number: [24BHI10098]
...
Give execute permission: chmod +x *.sh

Run any script: ./script1_system_info.sh

For log analyzer: ./script4_log_analyzer.sh /var/log/syslog
